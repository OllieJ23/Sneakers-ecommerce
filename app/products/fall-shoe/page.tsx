...
function page() {
  ...
  return (
    <div className="mt-8 flex flex-col items-center justify-center gap-10 sm:flex-row lg:gap-40">
      <ShoePics
        thumbnailURLs={[
          "/images/product-1-images/image-product-1-thumbnail.jpg",
          "/images/product-1-images/image-product-2-thumbnail.jpg",
          "/images/product-1-images/image-product-3-thumbnail.jpg",
          "/images/product-1-images/image-product-4-thumbnail.jpg",
        ]}
